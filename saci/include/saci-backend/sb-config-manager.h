...
struct sb_ConfigManager {
    ...
    struct sb_RenderApiFuncs {
        struct {
            ...
            void (*debug_message_callback)(sb_DebugCallback, const void*);
            ...
            void (*uniform_matrix_2fv)(su_S32 location, su_S32 count, su_Bool transpose, const float* value);
            void (*uniform_matrix_3fv)(su_S32 location, su_S32 count, su_Bool transpose, const float* value);
            void (*uniform_matrix_4fv)(su_S32 location, su_S32 count, su_Bool transpose, const float* value);
            void (*uniform_matrix_2x3fv)(su_S32 location, su_S32 count, su_Bool transpose, const float* value);
            void (*uniform_matrix_2x4fv)(su_S32 location, su_S32 count, su_Bool transpose, const float* value);
            void (*uniform_matrix_3x2fv)(su_S32 location, su_S32 count, su_Bool transpose, const float* value);
            void (*uniform_matrix_3x4fv)(su_S32 location, su_S32 count, su_Bool transpose, const float* value);
            void (*uniform_matrix_4x2fv)(su_S32 location, su_S32 count, su_Bool transpose, const float* value);
            void (*uniform_matrix_4x3fv)(su_S32 location, su_S32 count, su_Bool transpose, const float* value);

            void (*bind_vertex_array)(su_U32 array);
            void (*bind_buffer)(su_U32 target, su_U32 buffer);
            void (*buffer_data)(su_U32 target, su_S64 size, const void* data, su_U32 usage);
            void (*buffer_subdata)(su_U32 target, su_S64 offset, su_S64 size, const void* data);
            void (*gen_buffers)(su_S32 n, su_U32* buffers);
            void (*gen_vertex_arrays)(su_S32 n, su_U32* arrays);
            void (*vertex_attrib_pointer)(su_U32 index, su_S32 size, su_U32 type, su_Bool normalized, su_S32 stride, const void* pointer);
            ...
            void (*tex_image_2d)(su_U32 target, su_S32 level, su_U32 internalformat,
