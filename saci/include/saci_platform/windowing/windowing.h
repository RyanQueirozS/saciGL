...
typedef void (*PSaciWindowMousePosHandler)(union PSaciWindow*, int, int);
typedef void (*PSaciWindowSizeHandler)(union PSaciWindow*, int, int);
typedef void (*PSaciWindowPosHandler)(union PSaciWindow*, int, int);
