/**
 * @file sc_shader.h
 * @brief This header defines functions for compiling shaders and creating shader programs
 * in the SACI engine.
 *
 * @details
 * This file contains functions for compiling vertex, fragment, and geometry shaders from
 * source code, as well as functions for linking these shaders into shader programs that
