 ...
 * amount
 *
 * @param[in] context The context of the warn
 * @param[in] message The message explaining the warn
 * @param[in] file The file the warn comes from
 * @param[in] line The line the warn comes from
 */
void sa_Log_Warn(enum sa_logSeverity severity,
                 enum sa_logContext context,
                 const char* message, const char* file, int line);
