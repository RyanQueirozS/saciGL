...
const char* __sc_logContextToString(int level) {
    switch (level) {
        case SACI_LOG_CONTEXT_OPENGL:
            return "OpenGL";
        case SACI_LOG_CONTEXT_OBJ_LOADING:
            return "OBJ_LOADING";
        case SACI_LOG_CONTEXT_RENDERER:
            return "Renderer";
        case SACI_LOG_CONTEXT_STBI:
            return "STBI";
        case SACI_LOG_CONTEXT_MEMORY_ALLOCATION:
            return "MEMORY_ALLOC";
        default:
            return "UNKOWN";
    }
...
void saci_OpenGLDebugMessageCallback(saci_u32 source, saci_u32 type, saci_u32 id, saci_u32 severity,
